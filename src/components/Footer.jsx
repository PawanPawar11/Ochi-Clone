    ...
    <div className="bg-blue-400 font-NeueMontreal text-[#212121] px-[3.375rem] py-[6.625]">
      <div className="w-full h-screen flex">
        <div className="w-1/2 font-FoundersGrotesk leading-[6.7rem] mt-[3.2rem]">
          ...
          <h1 className="uppercase text-[8.313rem]"> Opening</h1>
        </div>
        <div className="w-1/2">
          <h1 className="uppercase font-FoundersGrotesk text-[8.313rem]">
            Presentations
          </h1>
          <div>
